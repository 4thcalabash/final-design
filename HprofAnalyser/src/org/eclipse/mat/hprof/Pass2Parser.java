...
public class Pass2Parser extends AbstractParser
{
    ...
    private void readInstanceDump(long segmentStartPos) throws IOException
    {
        ...
        IHprofParserHandler.HeapObject heapObject = new IHprofParserHandler.HeapObject(handler.mapAddressToId(id), id, thisClazz, thisClazz
    ...
    private void readObjectArrayDump(long segmentStartPos) throws IOException
    {
        ...
        IHprofParserHandler.HeapObject heapObject = new IHprofParserHandler.HeapObject(handler.mapAddressToId(id), id, arrayType, ObjectArrayImpl
    ...
    private void readPrimitiveArrayDump(long segmentStartPost) throws SnapshotException, IOException
    {
        ...
        IHprofParserHandler.HeapObject heapObject = new IHprofParserHandler.HeapObject(handler.mapAddressToId(id), id, clazz, PrimitiveArrayImpl
    ...
    private void readPrimitiveArrayNoDataDump(long segmentStartPost)
        ...
        IHprofParserHandler.HeapObject heapObject = new IHprofParserHandler.HeapObject(handler.mapAddressToId(id), id, clazz,
