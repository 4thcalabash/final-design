...
public class HprofParserHandlerImpl implements IHprofParserHandler
{
    ...
    public void beforePass2(IProgressListener monitor) throws IOException, SnapshotException
    {
        ...
        outbound = new IndexWriter.IntArray1NWriter(this.identifiers.size(), IndexManager.Index.OUTBOUND.getFile(info.getPrefix()
                        + "temp."));//$NON-NLS-1$
    ...
    public IIndexReader.IOne2LongIndex fillIn(IPreliminaryIndex index) throws IOException
    {
        ...
        index.setArray2size(array2size.writeTo(IndexManager.Index.A2SIZE.getFile(info.getPrefix() + "temp."))); //$NON-NLS-1$
    ...
    public void addProperty(String name, String value) throws IOException
    {
        ...
        else if (IDENTIFIER_SIZE.equals(name))
        {
